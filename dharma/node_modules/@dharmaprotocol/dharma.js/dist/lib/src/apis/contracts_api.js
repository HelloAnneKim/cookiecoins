            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.config.termsContractRegistry) return [3 /*break*/, 2];
                        return [4 /*yield*/, wrappers_1.TermsContractRegistryContract.at(this.config.termsContractRegistry, this.web3, transactionOptions)];
                    case 1:
                        termsContractRegistry = _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, wrappers_1.TermsContractRegistryContract.deployed(this.web3, transactionOptions)];
                    case 3:
                        termsContractRegistry = _a.sent();
                        _a.label = 4;
                    case 4:
